...
import it.pagopa.pn.apikey.manager.generated.openapi.rest.v1.aggregate.api.PdndApi;
...
@RestController
@Slf4j
public class PdndController implements PdndApi {
    ...
    public PdndController(ManageApiKeyService manageApiKeyService,
